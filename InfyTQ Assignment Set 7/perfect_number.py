...
# The first perfect number is 6 as the sum of its proper positive divisors, 1,2 and 3 
# is 6. Other perfect numbers are 28, 496, 8128 ...

# Extend the program written for the above problem to write another function to find 
# all perfect numbers in a given list of numbers. Populate the perfect numbers in a list 
# and return the list. If no perfect numbers found, return an empty list.
